...
import com.amazing.ads.utils.SharedPreferencedUtils;
...
public class UIUtils {
    ...
    public static String getUUID(){
        String uuid="";
        String str = (String) SharedPreferencedUtils.getInt("uuid","");
        if(str.equals("")){
            uuid = UUID.randomUUID().toString();
            SharedPreferencedUtils.putInt("uuid",uuid);
        }else{
            uuid = (String) SharedPreferencedUtils.getInt("uuid","");
        }
        return uuid;
    }
